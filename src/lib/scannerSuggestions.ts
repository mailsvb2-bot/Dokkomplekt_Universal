...
const FIELDS: FieldDefinition[] = [
  ...
  { field_id: 'medical.case_number', title: 'Номер истории болезни / карты', kind: 'text', domains: ['medical'], keywords: ['история болезни', 'номер карты', 'медицинская карта', 'иб №'], valueTest: NUMBER_RE.test.bind(NUMBER_RE) },
  { field_id: 'medical.admission_date', title: 'Дата поступления', kind: 'date', domains: ['medical'], keywords: ['дата поступления', 'дата госпитализации', 'поступил', 'поступила'], valueTest: DATE_RE.test.bind(DATE_RE) },
  { field_id: 'medical.discharge_date', title: 'Дата выписки', kind: 'date', domains: ['medical'], keywords: ['дата выписки', 'выписан', 'выписана'], valueTest: DATE_RE.test.bind(DATE_RE) },
  { field_id: 'medical.diagnosis', title: 'Диагноз / заключение', kind: 'icd10', domains: ['medical'], keywords: ['диагноз', 'заключение', 'мкб', 'icd'], valueTest: ICD_RE.test.bind(ICD_RE) },
  { field_id: 'medical.treatment', title: 'Лечение / назначения', kind: 'long_text', domains: ['medical'], keywords: ['лечение', 'назначенное лечение', 'назначения', 'терапия'] },
  { field_id: 'medical.complaints', title: 'Жалобы', kind: 'long_text', domains: ['medical'], keywords: ['жалобы'] },
  { field_id: 'medical.status', title: 'Осмотр / статус', kind: 'long_text', domains: ['medical'], keywords: ['статус', 'осмотр', 'объективно', 'состояние'] },
