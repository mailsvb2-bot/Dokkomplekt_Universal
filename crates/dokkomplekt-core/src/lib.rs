...
pub mod workspace_profile_state;
...
pub use workspace_profile_state::*;
...
pub use created_documents::{
    ...
    source_service_note_key, ConfiguredDocument, CreatedDocumentsBatch, PlannedOutput,
    ATTENTION_SUFFIX, ATTENTION_TITLE,
};
