...
use dokkomplekt_core::{
    ...
    set_user_value, source_service_note_key, suggest_icd10, suggest_template_markup,
    template_counter_requests, template_image_requests, unreadable_note_file_name,
    validate_case_relations, validate_field_value, validate_output_button_labels,
    validate_popup_fields, BundleDecision, CaseFragment, ConfiguredDocument,
...
use dokkomplekt_docx::{
    apply_story_template_learning_map_file, apply_story_template_markup_file,
