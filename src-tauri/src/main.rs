...
use dokkomplekt_core::{
    analyze_template_text, analyze_template_text_with_context,
    analyze_template_text_with_domain_hint, apply_model_consensus_with_source,
    apply_model_output_with_source, apply_popup_answers, apply_scanner_marks, attention_file_name,
    build_corpus_entry, build_diary_plan, build_extraction_prompt_for_domain_and_language,
    build_merged_popup_plan, build_series_plan, case_for_mail_merge_row, corpus_entry_metrics,
    create_pack_from_confirmations, decide_document_bundle, decision_for_key,
    detect_field_conflict, document_pack_contains_template_source, empty_first_run_pack,
    evaluate_automation_quality, evaluate_print_triage_with_thresholds, extract_understanding,
    format_counter_value, is_valid_field_id, merge_document_pack, normalize_popup_fields,
    parse_delimited_table, parse_source_text, plan_created_documents_batch, plan_output_paths,
    plan_workflow_batch, prepare_template_confirmations_with_existing_pack,
