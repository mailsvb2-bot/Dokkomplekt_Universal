...
use dokkomplekt_core::{
    analyze_template_text, apply_model_consensus_with_source, apply_model_output_with_source,
    apply_popup_answers, apply_scanner_marks, attention_file_name, build_corpus_entry,
    build_diary_plan, build_extraction_prompt_for_domain_and_language, build_merged_popup_plan,
    build_series_plan, case_for_mail_merge_row, corpus_entry_metrics,
    create_pack_from_confirmations, decide_document_bundle, decision_for_key,
    ...
    parse_flexible_date, parse_source_text, plan_created_documents_batch, plan_output_paths,
    plan_workflow, plan_workflow_batch, prepare_template_confirmations, recommend_document_bundle,
    ...
    select_diary_template_for_admission, set_user_value, suggest_icd10, suggest_template_markup,
    template_counter_requests, template_image_requests, validate_case_relations,
    validate_field_value, validate_popup_fields, CaseFragment, ConfiguredDocument,
    CorpusAcceptanceSource, CorpusEntry, CorpusEntryMetrics, CorpusEntryRequest,
