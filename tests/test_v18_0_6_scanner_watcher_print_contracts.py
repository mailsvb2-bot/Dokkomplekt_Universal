...
class ScannerWatcherPrintContracts(unittest.TestCase):
    ...
    def test_background_watcher_is_windowless_by_default_and_installed_proof_is_idempotent(self) -> None:
        ...
        self.assertIn("Tao Thread Event Target", self.installer_smoke)
        self.assertIn("GetExtendedWindowStyle", self.installer_smoke)
        self.assertIn("fpr10WsExLayered", self.installer_smoke)
        self.assertIn("fpr10WsExTransparent", self.installer_smoke)
        self.assertIn("fpr10WsExToolWindow", self.installer_smoke)
        self.assertIn("fpr10WsExNoActivate", self.installer_smoke)
        self.assertIn("FPR-10 TAO EVENT TARGET OK", self.installer_smoke)
        self.assertIn("FPR-10 UIA EVENT TARGET OK", self.installer_smoke)
        self.assertIn("fpr10UiaSafeTaoEventTarget", self.installer_smoke)
